    ...
    <div className='grid lg:grid-cols-2 gap-24 items-center'>
      ...
      <div>
        ...
        <p className="mt-8 max-w-xl text-lg leading-8">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex, aspernatur rem! 
          Quas necessitatibus accusamus reiciendis maiores vitae eaque cupiditate ipsum?
        </p>
        <div className="mt-10">
